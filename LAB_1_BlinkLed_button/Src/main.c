...
#define GPIOA_ENR               (1U<<0)
#define PA1_LED_GREEN           (1U<<1)
#define PA2_LED_RED             (1U<<2)
#define PA3_LED_WHITE           (1U<<3)
#define PA4_BTN_1               (1U<<4)
#define PA5_BTN_2               (1U<<5)
...
while(1)
{
    ...
    // led_on(PA1_LED_GREEN);
	// delay_ms(3000, 16000);

	// led_on(PA2_LED_RED);
	// delay_ms(3000, 16000);

	// led_on(PA3_LED_WHITE);
	// delay_ms(3000, 16000);
}
